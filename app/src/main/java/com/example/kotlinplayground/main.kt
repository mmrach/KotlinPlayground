...
object Repository{
    ...
    fun fetch(whatHappend:com.example.kotlinplayground.Result){
...
object Repository4{
    ...
    // Una función que llamamos para simular que se descargan datos
    // le pasamos un parametro para simular que pasa en esa descarga.
    fun fetch(whatHappend:com.example.kotlinplayground.Result4){
        loadState = Loading
        println("  fetching…")
        try {
            // sleep for one second
...
object Repository5{
    ...
    // Una función que llamamos para simular que se descargan datos
    // le pasamos un parametro para simular que pasa en esa descarga.
    fun fetch(whatHappend:com.example.kotlinplayground.Result5){
        loadState = Loading5
        println("  fetching…")
        try {
            // sleep for one second
